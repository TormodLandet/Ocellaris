...
latex_documents = [
    ('index', 'Ocellaris.tex', u'Ocellaris Documentation', u'Tormod Landet', 'manual')
]
...
man_pages = [('index', 'ocellaris', u'Ocellaris Documentation', [u'Tormod Landet'], 1)]
