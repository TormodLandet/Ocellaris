from dolfin import (UnitSquareMesh, UnitCubeMesh, FunctionSpace, Function, Expression, 
...
def test_gradient_cpp_vs_py(dim, test_mpi):
    ...
    for d in range(dim):
        ...
        if test_mpi:
            g0 = comm_self_to_comm_world(schemes[0].gradient_reconstructor.gradient[d],
