    ...
    for cell in dolfin.cells(mesh):
        ...
        for dof in cell_dofs:
            ...
            if N == 3:
                ...
                # Linear tetrahedron
                A, B, C, D = coeffs
                vals[dof] = B*(pos[0] - xc[0]) + C*(pos[1] - xc[1]) + D*(pos[2] - xc[2])
            elif N == 10:
        ...
        if N == 3:
            ...
            avg_weights = [-1/20, -1/20, -1/20, -1/20, 1/5, 1/5, 1/5, 1/5, 1/5, 1/5]
...
@pytest.mark.parametrize("degree", [1, 2])
def test_taylor_values_2D(dim, degree):
    """
    ...
    if dim == 2:
        ...
        coeffs = [1, 2, -3.0, 2.5] if degree == 1 else [1, 2, -3.0, 2.5, -1.3, 4.2, -1.0, -4.2, 2.66, 3.14]
