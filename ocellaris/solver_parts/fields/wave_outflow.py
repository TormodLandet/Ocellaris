...
class WaveOutflowField(KnownField):
    ...
    def read_input(self, field_inp):
        ...
        err = lambda msg: ocellaris_error('Error in definition of WaveOutflow field %r'
                                          % self.name, msg)
        ...
        vel_inp = sim.input.get_value('boundary_conditions/%d/u' % inflow_index, required_type='Input')
    ...
    def tune_factors(self, setup=False):
        ...
        if False and abs(inlet_flux_below) > 0:
            ...
            print('flux_above', inlet_flux_above, outlet_flux_above, outlet_flux_above/inlet_flux_above)
            print('flux_below', inlet_flux_below, outlet_flux_below, outlet_flux_below/inlet_flux_below)
            print('flux_total', inlet_flux_total, outlet_flux_total, outlet_flux_total/inlet_flux_total)
            print(xN - x0)
            print(niter)
