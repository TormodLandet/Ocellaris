...
def taylor_to_DG2_matrix(V):
    ...
    for cell in cells(mesh):
        ...
        bar_xy = (-x1**2/9 - 2*x1*x2/9 - 2*x1*x3/9 + 5*x1*y1/18 + 7*x1*y2/36
                  + 7*x1*y3/36 - x2**2/9 - 2*x2*x3/9 + 7*x2*y1/36 + 5*x2*y2/18
                  + 7*x2*y3/36 - x3**2/9 + 7*x3*y1/36 + 7*x3*y2/36 + 5*x3*y3/18
                  - y1**2/9 - 2*y1*y2/9 - 2*y1*y3/9 - y2**2/9 - 2*y2*y3/9 - y3**2/9)
