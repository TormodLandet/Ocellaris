...
def plot_iso_surface_file(file_name):
    ...
    plots = [('Horizontal maximum', [('MM', mmTvec, mmZvec), ('DG', Tvec, Zvec)]),
             ('Vertical maximum',   [('MM', mmYvec, mmHvec), ('DG', Yvec, Hvec)])]
...
if __name__ == '__main__':
    import sys
    iso_surface_file_name = sys.argv[1]
    plot_iso_surface_file(iso_surface_file_name)
    pyplot.show()
